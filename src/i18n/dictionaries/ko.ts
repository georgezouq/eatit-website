...
const ko: LocaleDictionary = {
  ...
  sections: {
    ...
    smart: {
      ...
      subtitle: "프라이버시 중심의 고급 식품 인텔리전스.",
      bullets: [
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          price: "₩9,900",
          period: "월",
          description: "무제한 스캔과 주도적인 AI 코칭을 이용하세요.",
          cta: "Plus로 업그레이드",
          popular: true,
          features: [
            "스캔·라벨 분석 무제한",
        ...
        },
        {
          ...
          price: "₩99,000",
          period: "연",
          description: "연간 할인으로 고급 분석과 우선 지원을 누리세요.",
          cta: "Pro로 전환",
          features: [
            "Plus의 모든 기능",
            "심층 트렌드 내보내기 및 연동",
      ...
      note: "기업 웰니스 프로그램이 필요하신가요? 맞춤형 영양 대시보드를 상담해 드립니다.",
    },
    privacy: {
      id: "privacy",
