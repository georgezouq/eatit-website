...
const es: LocaleDictionary = {
  ...
  sections: {
    ...
    smart: {
      ...
      subtitle: "Tecnología alimentaria avanzada con privacidad de primer nivel.",
      bullets: [
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          price: "€7.99",
          period: "Al mes",
          description: "Desbloquea escaneos ilimitados y coaching proactivo.",
          cta: "Actualizar a Plus",
          popular: true,
          features: [
            "Escaneos y lecturas ilimitadas",
            "Análisis dinámico de carencias nutricionales",
            "Coach IA con recordatorios de hábitos",
          ],
        },
        {
          name: "EatIt Pro",
          price: "€79",
          period: "Al año",
          description: "Ahorro anual con analíticas avanzadas y soporte prioritario.",
          cta: "Pasar a Pro",
          features: [
            "Todo lo incluido en Plus",
            "Exportaciones de tendencias e integraciones",
            "Sesiones prioritarias con nutricionistas cada trimestre",
          ],
        },
      ],
      note: "¿Programas corporativos? Escríbenos para paneles de nutrición personalizados.",
    },
    privacy: {
      id: "privacy",
