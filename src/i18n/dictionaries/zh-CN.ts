...
const zhCN: LocaleDictionary = {
  ...
  sections: {
    ...
    includes: {
      ...
      badge: "Eatibo 包含什么？",
      title: "Eatibo 包含什么？",
      subtitle: "从饮食扫描到体重管理，一套完整能力帮助你建立更健康的每日节奏。",
      autoplayLabel: "Eatibo 核心卖点轮播",
      features: [
        {
          key: "scan-diets",
          title: "食物扫描与饮食习惯",
          description: "拍一拍配料表或餐盘，Eatibo 会自动匹配你的饮食偏好。",
          points: [
            "支持地中海、无菜籽油、生酮、清真等饮食方式",
            "基于历史习惯给出更贴合的建议",
          ],
          image: {
        ...
        },
        {
          key: "medication",
          title: "用药提醒",
          description: "结合你的生活节奏，避免漏服和错过关键时段。",
          points: [
            "每日固定提醒，贴合三餐与作息",
            "温和通知，不打扰休息时段",
          ],
        ...
        },
        {
          key: "hydration",
          title: "饮水提醒",
          description: "轻松记录每天饮水量，保持稳定补水习惯。",
          points: [
            "按时间与活动动态提醒补水",
            "可视化进度激励你完成每日目标",
          ],
        ...
        },
        {
          key: "weight-goals",
          title: "体重管理",
          description: "支持减肥与增肥双目标，帮你更科学地达成体型计划。",
          points: [
            "减脂与增重模式自由切换",
            "结合扫描记录给出趋势反馈",
          ],
