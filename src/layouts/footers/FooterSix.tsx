            ...
            <div className="row">
              <div className="col-lg-5 me-auto">
                <div className="footer-intro mb-30 me-xxl-5 pe-xxl-4">
                  ...
                  <form onSubmit={(e) => e.preventDefault()} className="position-relative">
                    ...
                    <button className="tran3s"><Image src={icon_1} alt="Newsletter submit icon" className="m-auto" /></button>
                  </form>
                </div>
              </div>
              ...
              <div className="col-xl-2 col-lg-3 col-6">
                <div className="footer-nav mb-40">
                  ...
                  <Image src={shape_2} alt="Decorative dotted divider" className="mt-50" />
                </div>
              </div>
          ...
          <div className="bottom-footer">
            <div className="d-md-flex align-items-center justify-content-between">
              <div className="d-flex justify-content-center align-items-center sm-mb-20">
                ...
                <Image src={shape} alt="Decorative footer accent" className="ms-5 d-none d-md-block" />
              </div>
