...
import logo from "@/assets/images/logo/logo_01.1.svg"
         ...
         <div className="position-relative z-1">
            <div className="container">
               <div className="email-banner position-relative z-1 bg-three border-30">
                  <div className="row align-items-center">
                     <div className="col-lg-6">
                        <h3 className="color-dark">Subscribe Now!</h3>
                     </div>
                     <div className="col-lg-6">
                        <form onSubmit={(e) => e.preventDefault()} className="position-relative">
                           <input type="email" placeholder="Your email address" />
                           <button className="tran3s"><Image src={icon_1} alt="Submit email icon" className="m-auto" /></button>
                        </form>
                     </div>
                  </div>
               </div>
               <div className="position-relative">
                  <div className="row">
                     <div className="col-lg-3">
                        <div className="footer-intro mb-30">
                           <div className="logo">
                              <Link href="/">
                                 <Image src={logo} alt="Hairwow primary logo" />
                              </Link>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="footer-contact mb-20">
                           <p className="fw-500 fs-20 mb-30 md-mb-20">210 Wallent Street, California, Main OC, USA</p>
                           <Link href="#" className="tel fw-500 fs-24 tran3s mb-40">(+91) 0187 34 377</Link>
                  ...
                  <p className="copyright-text m0"><strong className="text-white">@2024.</strong> All Right Reserved. </p>
               </div>
            </div>
         </div>
      </div>
