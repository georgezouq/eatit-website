            ...
            <div className="top-header position-relative">
               <div className="d-flex align-items-center justify-content-between">
                  ...
                  <div className="order-lg-2 me-auto ms-xxl-5 ps-5 d-none d-md-inline-block">
                     <p className="m0 fs-20 font-manrope fw-500">Call <a href="#" className="fw-600 text-fw-600 text-white">+757 699-4478</a>
                     </p>
                  </div>
                     ...
                     <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav align-items-lg-center">
                           <li className="d-block d-lg-none">
                              <div className="logo"><Link href="index.html" className="d-block"><Image src={logo_1} alt="Hairwow logo" /></Link></div>
                           </li>
                           <NavMenu />
                           ...
                           <li className="d-md-none ps-3 pe-3 mt-20">
                              <p className="m0 fs-20 font-manrope text-center fw-500">Call <Link href="#"
                                 className="fw-600 text-white">+757 699-4478</Link></p>
                           </li>
                        </ul>
                     </div>
                  </nav>
