               ...
               <div className="d-flex align-items-center">
                  ...
                  <div className="search-form me-auto ms-xxl-5 ps-lg-5 d-none d-xl-block">
                     <form onSubmit={(e) => e.preventDefault()} className="position-relative">
                        <button><Image src={icon} alt="Search icon" /></button>
                  ...
                  <div className="right-widget ms-lg-5 ps-xxl-5 me-3 me-lg-0 order-lg-3">
                     <ul className="d-flex align-items-center style-none">
                        <li>
                           <Link href="/login" className="login-btn-four fw-500 d-flex align-items-center tran3s"><Image src={icon_2} alt="User profile icon" className="me-2" /> <span>Login</span></Link>
                        </li>
                        <li className="d-none d-md-inline-block ms-4">
                           <Link href="/signup" className="btn-five border-0 tran3s">Sign Up</Link>
                        </li>
                     </ul>
                  </div>
