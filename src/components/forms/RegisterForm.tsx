            ...
            <div className="col-12">
               <div className="input-group-meta position-relative mb-20">
                  ...
                  <span className="placeholder_icon">
                     {isPasswordVisible ? (
                        <span onClick={togglePasswordVisibility} className="passVicon eye-slash"><Image src={icon_1} alt="Hide password icon" /></span>
                     ) : (
                        <span onClick={togglePasswordVisibility} className="passVicon"><Image src={icon_1} alt="Show password icon" /></span>
                     )}
                  </span>
