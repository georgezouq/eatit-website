               ...
               <div className="row align-items-center">
                  <div className="col-lg-6 order-lg-last ms-auto">
                     <div className="title-ten">
                        <div className="fs-22 text-white mb-15">Why Us</div>
                  ...
                  <div className="col-lg-5 col-md-8 m-auto m-lg-0">
                     <div className="img-box position-relative z-1 md-mt-40">
                        <Image src={thumb} alt="Decorative graphic" />
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div className="row justify-content-between">
                  <div className="col-xxl-3 col-lg-4 col-md-6">
                     <div className="card-style-thirteen d-flex align-items-center w-100 mt-35">
                        <div className="icon d-flex align-items-center justify-content-center border border-2 border-white rounded-circle"><Image src={icon_1} alt="Decorative graphic" /></div>
                        <div className="text">
                  ...
                  <div className="col-xxl-3 col-lg-4 col-md-6">
                     <div className="card-style-thirteen d-flex align-items-center w-100 mt-35">
                        <div className="icon d-flex align-items-center justify-content-center border border-2 border-white rounded-circle"><Image src={icon_2} alt="Decorative graphic" /></div>
                        <div className="text">
                  ...
                  <div className="col-xxl-3 col-lg-4 col-md-6">
                     <div className="card-style-thirteen d-flex align-items-center w-100 mt-35">
                        <div className="icon d-flex align-items-center justify-content-center border border-2 border-white rounded-circle"><Image src={icon_3} alt="Decorative graphic" /></div>
                        <div className="text">
