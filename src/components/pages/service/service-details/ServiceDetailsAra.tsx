                ...
                <div className="wrapper m-auto">
                    ...
                    <div className="row">
                        <div className="col-sm-8">
                            <Image src={img_1} alt="Decorative graphic" className="w-100 mt-10"/>
                        </div>
                        <div className="col-sm-4">
                            <Image src={img_2} alt="Decorative graphic" className="w-100 mt-10"/>
                        </div>
                    </div>
                        ...
                        <div className="row gx-xxl-5">
                            <div className="col-lg-4">
                                <div className="card-style-fifteen text-center mt-25">
                                    <div className="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><Image src={icon_1} alt="Decorative graphic"/></div>
                                    <h6>Collect Doc</h6>
                            ...
                            <div className="col-lg-4">
                                <div className="card-style-fifteen text-center mt-25">
                                    <div className="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><Image src={icon_2} alt="Decorative graphic"/></div>
                            ...
                            <div className="col-lg-4">
                                <div className="card-style-fifteen text-center mt-25">
                                    <div className="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><Image src={icon_3} alt="Decorative graphic"/></div>
                                    <h6>Completedy</h6>
