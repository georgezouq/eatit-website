            ...
            <div className="row">
               <div className="col-lg-7 me-auto">
                  <div className="pe-xxl-5">
                     <Image src={counter_icon} alt="Decorative graphic" className="icon mb-35" />
                     ...
                     <div className="media-block border-30 mt-70 lg-mt-30 d-flex align-items-end">
                        <div className="name-card w-100 d-flex align-items-center justify-content-between">
                           <div>
                              <h6>Maria Gomez</h6>
                              <span className="text-white">CEO & Founder, Piku inc</span>
                           </div>
                           <Image src={counter_logo} alt="Decorative graphic" />
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div className="wrapper position-relative md-mt-40">
                     {counter_data.map((item) => (
                        <div key={item.id} className={`card-style-three position-relative z-1 ${item.class}`}>
                           ...
                           <Image src={item.shape} alt="Decorative graphic" className="shapes shape_01" />
                        </div>
                     ))}
                     <Image src={counter_shape} alt="Decorative graphic" className="shapes bg-shape" />
                  </div>
               </div>
            </div>
         </div>
