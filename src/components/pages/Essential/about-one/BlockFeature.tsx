            ...
            <div className="row align-items-center">
               <div className="col-xl-7 col-lg-6 order-lg-last">
                  <div className="ps-xl-5">
                     ...
                     <p className="fs-28 fw-500 text-white mt-55 lg-mt-30 mb-70 lg-mb-40 pe-xxl-5">“Piku provides virtual debit cards and FDIC-insured USD accounts, available through City Savings for added security and convenience.”</p>
                     <div className="fs-24 text-white mb-40 lg-mb-30">- CEO, Piku inc</div>
                     <Link href="/contact-v1" className="btn-one">Let’s Started</Link>
                  </div>
               </div>
               <div className="col-xl-5 col-lg-6">
                  <Image src={thumb} alt="Decorative graphic" className="media-img md-mt-40" />
               </div>
            </div>
         </div>
