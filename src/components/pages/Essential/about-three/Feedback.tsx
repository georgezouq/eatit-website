...
import logo_1 from "@/assets/images/logo/p_logo_33.png"
import logo_2 from "@/assets/images/logo/p_logo_34.png"
import logo_3 from "@/assets/images/logo/p_logo_35.png"
...
const testi_data: DataType[] = [
   {
      id: 1,
      logo: logo_1,
      title: (<><span className="fw-500">Mark Joge,</span> Marketing Chief</>),
      desc: (<>“I have been using Piku since I got it and I love it!”</>),
   },
   {
      id: 2,
      logo: logo_2,
      title: (<><span className="fw-500">Rashed kabir,</span> Lead Designer</>),
...
const Feedback = () => {
   return (
      <div className="feedback-section-ten mt-180 xl-mt-150 lg-mt-80 mb-130">
               ...
               <Swiper {...setting} modules={[Autoplay]} className="feedback-slider-seven">
                  {testi_data.map((item) => (
                     <SwiperSlide key={item.id} className="item">
                        <div className="feedback-block-four style-two border border-2 border-white">
