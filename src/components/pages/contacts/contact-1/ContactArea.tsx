               ...
               <div className="row align-items-center">
                  <div className="col-xl-3 col-lg-4">
                     <div className="block d-flex align-items-center">
                        <div className="icon d-flex align-items-center justify-content-center rounded-circle"><Image src={icon_1} alt="Decorative graphic" /></div>
                        <div className="text">
                  ...
                  <div className="col-xl-3 col-lg-4">
                     <div className="block d-flex align-items-center ps-xl-5">
                        <div className="icon d-flex align-items-center justify-content-center rounded-circle"><Image src={icon_3} alt="Decorative graphic" /></div>
                        <div className="text">
