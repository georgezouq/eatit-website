            ...
            <div className="row align-items-center">
               ...
               <div className="col-lg-5 col-md-6 ms-auto">
                  <div className="d-inline-flex position-relative z-1 sm-mt-40">
                     <Image src={avatar_1} alt="Decorative graphic" className="rounded-circle avatar-group" />
                     <Image src={avatar_2} alt="Decorative graphic" className="rounded-circle avatar-group" />
                     <Image src={avatar_3} alt="Decorative graphic" className="rounded-circle avatar-group" />
                     <Image src={avatar_4} alt="Decorative graphic" className="rounded-circle avatar-group" />
                     <Image src={shape} alt="Decorative graphic" className="shapes shape_01" />
                  </div>
                  <p className="fs-24 mt-20 lg-mt-10">Client satisfaction speaks louder than our words. Hear from them.</p>
               </div>
            </div>
         </div>
         <div className="container">
                     ...
                     <SwiperSlide key={item.id} className="item">
                        <div className="feedback-block-two">
                           ...
                           <div className="d-flex align-items-center justify-content-between">
                              ...
                              <Image src={item.avatar} alt="Decorative graphic" className="rounded-circle client-avatar" />
                           </div>
                        </div>
                     </SwiperSlide>
                  ))}
