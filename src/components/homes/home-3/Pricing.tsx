               ...
               <div key={item.id} className="pr-table-wrapper position-relative z-1 mt-40" style={{ backgroundImage: `url(${item.pricing_bg})` }}>
                  <div className="row">
                     <div className="col-lg-3 ms-auto">
                        ...
                        <p className="fs-22 text-white">{item.title}</p>
                     </div>
                     ...
                     <div className="col-lg-3 col-sm-5 text-center">
                        ...
                        <strong className="fs-20 fw-bold d-block text-white text-uppercase mt-20">{item.offer}</strong>
                        <p className="fs-20 text-white">Full Payment</p>
                     </div>
                  </div>
