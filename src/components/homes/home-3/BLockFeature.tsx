         ...
         <div className="container">
            <div className="row">
               ...
               <div className="col-xxl-5 col-lg-6 ms-auto">
                  ...
                  <Link href="/about-us-v3" className="btn-eight d-inline-flex align-items-center">More Details <Image src={icon} alt="Decorative graphic" className="ms-3" /></Link>
               </div>
            </div>
                     ...
                     <SwiperSlide key={item.id} className="item">
                        <div className="card-style-four position-relative" style={{ backgroundImage: `url(${item.bg_img})` }}>
                           <div className="d-flex justify-content-between align-items-center">
                              <Image src={item.logo} alt="Decorative graphic" />
                              <Image src={item.shape} alt="Decorative graphic" />
                           </div>
                           {item.count}
                           <p className="font-manrope fs-24 text-white">{item.title}</p>
                        </div>
                     </SwiperSlide>
                  ))}
               </Swiper>
