      ...
      <div className="hero-banner-three z-1 position-relative pt-200 lg-pt-150">
         <div className="container position-relative">
            <div className="row">
               <div className="col-xl-10 col-lg-10 m-auto text-center">
                  ...
                  <p className="fs-28 pt-40 lg-pt-30 pb-35 lg-pb-20">What kind of website would you like to create? Let’s Get started</p>
         ...
         <div className="media d-flex justify-content-center mt-100 lg-mt-60">
            <div className="position-relative">
               ...
               <Image src={img_2} alt="Decorative graphic" className="shapes card_01" />
               <Image src={img_3} alt="Decorative graphic" className="shapes card_02" />
            </div>
         </div>
         <Image src={img_4} alt="Decorative graphic" className="shapes shape_01" />
         <Image src={img_5} alt="Decorative graphic" className="shapes shape_02" />
      </div>
   )
}
