               ...
               <div className="col-xl-10 col-lg-10 m-auto text-center">
                  <h2 className="hero-heading font-Montserrat d-flex align-items-center justify-content-center flex-wrap">
                     ...
                     <span className="position-relative">
                        PROJECT
                        <Image src={img_1} alt="Decorative graphic" className="shapes smile_icon" />
                        <Image src={img_2} alt="Decorative graphic" className="shapes shape_01" />
                     </span>
                     <Image src={img_3} alt="Decorative graphic" className="shape shape_02 me-lg-4" />
                     <span>IN MIND?</span>
                     <Image src={img_4} alt="Decorative graphic" className="shape shape_03 ms-lg-4" />
                  </h2>
