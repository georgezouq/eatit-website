            ...
            <div className="row">
               <div className="col-12">
                  <h1 className="hero-heading text-center d-flex align-items-center justify-content-center flex-wrap">
                     <Image src={img_1} alt="Decorative graphic" className="shape shape_01 me-xl-5 me-4" />
                     <span>DESIGN</span>
                     <Image src={img_2} alt="Decorative graphic" className="shape shape_02 ms-xl-5 ms-4" />

                     <span className="position-relative w-100">
                        <Image src={img_3} alt="Decorative graphic" className="shapes shape_05" />
                        BRAIN<span className="fst-italic">STORM.</span>
                        <Image src={img_4} alt="Decorative graphic" className="shapes smile_icon" />
                        <Image src={img_5} alt="Decorative graphic" className="shapes shape_06" />
                     </span>

                     <Image src={img_6} alt="Decorative graphic" className="shape shape_03 me-xl-5 me-4" />
                     <span>Coding</span>
                     <Image src={img_7} alt="Decorative graphic" className="shape shape_04 ms-xl-5 ms-4" />
                  </h1>
                  ...
                  <div className="d-sm-flex justify-content-between align-items-center">
                     <div className="mt-20 xs-mt-40">
                        <Image src={img_8} alt="Decorative graphic" className="m-auto" />
                        <div className="rating text-center text-sm-start xs-pt-10 xs-pb-20">
                           <div className="fs-24"><span className="fw-500 text-white">13k rating</span> (4.7 Rating)</div>
                        </div>
                     </div>
                     <Image src={img_9} alt="Decorative graphic" className="wave-shape d-none d-lg-block" />
                     <div className="mt-20 text-center text-sm-start">
                        <div className="position-relative d-inline-block quote-bg">
                           <Image src={img_10} alt="Decorative graphic" />
