            ...
            <div className="row gx-xxl-5 align-items-center">
               <div className="col-lg-7">
                  ...
                  <div className="d-flex align-items-center">
                     ...
                     <Image src={img_1} alt="Decorative graphic" className="d-none d-sm-block" />
                  </div>
               </div>
               <div className="col-lg-5 text-center text-lg-end">
                  <div className="img-box d-inline-block position-relative z-1">
                     <Image src={img_2} alt="Decorative graphic" className="main-img" />
                     <div className="text-sticker">
                        <Image src={img_3} alt="Decorative graphic" />
