   ...
   return (
      <div className="app-integration-one mt-170 xl-mt-150 lg-mt-80">
            ...
            <Swiper {...setting} modules={[Autoplay]} className="partner-logo-two">
               {logo_data.map((item) => (
                  <SwiperSlide key={item.id} className="item">
                     <div className="logo-box d-flex align-items-center justify-content-center" style={{ background: item.bg }}><Image src={item.logo} alt="Decorative graphic" /></div>
                  </SwiperSlide>
               ))}
            </Swiper>
         </div>
         ...
         <div className="text-center mt-75 lg-mt-40">
            <p className="fs-28 font-manrope mb-25">Connect more than 6000+ tools</p>
