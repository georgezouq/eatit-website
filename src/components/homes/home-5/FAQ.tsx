         ...
         <div className="container">
            <div className="row">
               <div className="col-lg-5">
                  ...
                  <p className="fs-22 pe-xxl-5 mt-40 md-mt-10 mb-40">Find your answers here. if you don’t find it here, please contact us.</p>
                  <Link href="/contact-v2" className="btn-eleven style-two">Contact us</Link>
               </div>
               <div className="col-lg-7">
                  <div className="accordion accordion-style-two p0 bg-transparent shadow-none ms-xl-4 md-mt-40" id="accordionFour">
                     {faqData.map((item) => (
