               ...
               {feature_data.map((item) => (
                  <div key={item.id} className="col-lg-4">
                     <div className="card-style-seven position-relative text-center mt-30 pb-45 lg-pb-30">
                        <Image src={item.icon} alt="Decorative graphic" className="icon m-auto" />
                        <h4>{item.title}</h4>
                     </div>
                  </div>
               ))}
               ...
               <div className="row">
                  <div className="col-lg-8 d-flex">
                     <div className="feature-block block-one w-100 mt-30" style={{ background: "#FFEB80" }}>
                        <h3 className="color-dark">Track Project</h3>
                        <div className="row">
                           <div className="col-md-9">
                              <p className="fs-24 text-dark">Efficiently monitor project progress, ensuring timelines, resource allocation, </p>
                           </div>
                        </div>
                        <Image src={img_1} alt="Decorative graphic" className="w-100 mt-70 md-mt-40" />
                  ...
                  <div className="col-lg-4 d-flex">
                     <div className="feature-block block-one w-100 mt-30" style={{ background: "#76FFCE" }}>
                        <h3 className="color-dark">Plan Project</h3>
                        <div className="row">
                           <div className="col-12">
                              <p className="fs-24 text-dark">Efficiently monitor project progress, resource allocation</p>
                           </div>
                        </div>
                        <Image src={img_3} alt="Decorative graphic" className="w-100 mt-40" />
                     ...
                     <div className="feature-block block-one w-100 mt-50 lg-mt-30 pe-0" style={{ background: "#D3A7FF" }}>
                        <div className="row">
                           <div className="col-lg-6">
                              <h3 className="color-dark">Team Collaboration & Communication</h3>
                              <div className="row">
                           ...
                           <div className="col-lg-6">
                              <Image src={img_5} alt="Decorative graphic" className="ms-auto mt-20 md-mt-40 mb-60 md-mb-10" />
                           </div>
                        </div>
                        <Image src={img_6} alt="Decorative graphic" className="shapes shape_03" />
                     </div>
                  </div>
               </div>
            </div>
