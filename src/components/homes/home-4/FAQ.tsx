                  ...
                  <div className="col-lg-6 order-lg-last">
                     <div className="ms-lg-5 ps-xxl-3">
                        <div className="title-six">
                           <h2 className="color-dark">We’re the Boss in This Market</h2>
                        </div>
                              ...
                              <div key={item.id} className="accordion-item">
                                 ...
                                 >
                                    <div className="accordion-body">
                                       <p className="fs-22 color-dark">{item.desc}</p>
                                    </div>
                                 </div>
                              </div>
                           ))}
                        </div>
                        <Link href="/faq-v1" className="btn-seven style-two">Explore More <i className="fa-sharp fa-regular fa-arrow-right-long"></i></Link>
                     </div>
                  </div>
