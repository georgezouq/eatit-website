...
import brand_1 from "@/assets/images/logo/p_logo_01_1.png"
import brand_2 from "@/assets/images/logo/p_logo_02_1.png"
import brand_3 from "@/assets/images/logo/p_logo_03_1.png"
import brand_4 from "@/assets/images/logo/p_logo_04_1.png"
import brand_5 from "@/assets/images/logo/p_logo_05_1.png"
import brand_6 from "@/assets/images/logo/p_logo_06_1.png"
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-6 col-md-10">
                     <h1 className="hero-heading color-dark font-Playfair">Develop lasting client relations  </h1>
                  ...
                  <div className="col-lg-6">
                     <Image src={hero_thumb} alt="Decorative graphic" className="illustration" />
                  </div>
               </div>
                  ...
                  <div className="container">
                     ...
                     <Swiper {...setting} modules={[Autoplay]} className="partner-logo-one">
                        {brand_data.map((brand, i) => (
                           <SwiperSlide key={i} className="item"><Image src={brand} alt="Decorative graphic" /></SwiperSlide>
                        ))}
                     </Swiper>
                  </div>
               </div>
