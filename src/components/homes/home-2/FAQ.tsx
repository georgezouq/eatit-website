...
const faq_data: ContentType[] = [
   {
      id: 1,
      content_details: {
         btn: (<><div className="pointer" style={{ background: "#FFCE52" }}>Account <Image src={shape_1} alt="Decorative graphic" /></div></>),
   ...
   },
   {
      ...
      content_details: {
         btn: (<><div className="pointer" style={{ background: "#FF4BD8" }}>Financial <Image src={shape_2} alt="Decorative graphic" /></div></>),
   ...
   },
   {
      ...
      margin: "mt-90 lg-mt-60",
      content_details: {
         btn: (<><div className="pointer" style={{ background: "#00D9B2" }}>Common <Image src={shape_3} alt="Decorative graphic" /></div></>),
         title: "Questions & Answers",
      },
      faq_area: {
         id: 1,
...
const FAQ = () => {
   ...
   return (
      <div className="faq-section-two position-relative z-1 mt-250 xl-mt-200 lg-mt-80 mb-200 xl-mb-150 lg-mb-80">
         ...
         <Image src={faq_shape_1} alt="Decorative graphic" className="shapes shape_01" />
      </div>
   )
}
