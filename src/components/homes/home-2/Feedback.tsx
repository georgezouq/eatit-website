         ...
         <div className="container">
            <div className="row align-items-center">
               <div className="col-lg-5 col-md-6">
                  ...
                  <h2>We’ve been <br /> helping <Image src={title_shape} alt="Decorative graphic" className="d-inline-block" /> <br />
               ...
               <div className="col-lg-7 col-md-6 text-end">
                  <div className="feedback-card position-relative z-1 ms-xxl-4 sm-mt-40">
                     <Image src={testi_thumb} alt="Decorative graphic" className="w-100" />
                  </div>
               </div>
            </div>
         </div>
