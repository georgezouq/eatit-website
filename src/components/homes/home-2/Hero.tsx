         ...
         <div className="container position-relative">
            <div className="row">
               <div className="col-xl-10 col-lg-8 m-auto text-center">
                  ...
                  <p className="fs-28 font-manrope pt-5 pb-30 lg-pb-20">Knowledge, answers, ideas. Just a click away</p>
                  <Link href="/service-v2" className="btn-three">Generate Now</Link>
               </div>
            </div>
            <Image src={img_1} alt="Decorative graphic" className="w-100 mt-70 lg-mt-50" />
         </div>
         <div className="client-logo-wrapper mt-80 lg-mt-40">
            <div className="container">
               <p className="font-manrope fs-24 fw-500 text-center mb-40">Over <span className="fw-600 text-white">32K+</span> software businesses growing with piku</p>
               <Swiper {...setting} modules={[Autoplay]} className="partner-logo-one">
                  {brand_data.map((item, i) => (
                     <SwiperSlide key={i} className="item"><Image src={item} alt="Decorative graphic" className="m-auto" /></SwiperSlide>
                  ))}
               </Swiper>
            </div>
         </div>
         <Image src={shape_1} alt="Decorative graphic" className="shapes shape_01" />
         <Image src={shape_2} alt="Decorative graphic" className="shapes shape_02" />
      </div>
   )
}
