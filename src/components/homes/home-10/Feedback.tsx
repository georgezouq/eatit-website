...
const testi_data: DataType[] = [
   {
      id: 1,
      logo: logo_1,
      title: (<><span className="fw-500 text-white">Mark Joge,</span> Marketing Chief</>),
      desc: (<>“I have been using Piku since I got it and I love it!”</>),
   },
   {
      id: 2,
      logo: logo_2,
      title: (<><span className="fw-500 text-white">Rashed kabir,</span> Lead Designer</>),
               ...
               <div className="row">
                  <div className="col-xl-7 col-lg-6 m-auto">
                     <div className="title-ten text-center mb-70 lg-mb-40">
                        <h2 className="color-dark">73,0000+ Client using our services</h2>
                     </div>
                  </div>
               </div>
                     ...
                     <SwiperSlide key={item.id} className="item">
                        <div className="feedback-block-four border border-2 border-dark">
                           ...
                           <div className="d-lg-flex align-items-center justify-content-between">
                              <div className="name text-dark">{item.title}</div>
