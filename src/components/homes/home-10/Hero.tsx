            ...
            <div className="container lg">
               <div className="row">
                  <div className="col-xxl-5 col-xl-7 col-lg-8 col-md-10">
                     <h1 className="color-dark hero-heading font-Montserrat">Opt-in for Cyber Safety, stay secure.</h1>
                     ...
                     <ul className="d-flex align-items-center flex-wrap style-none btn-group">
                        <li><Link href="/" className="active"><Image src={icon_1} alt="Decorative graphic" /> Download for Mac</Link></li>
                        <li><Link href="/"><Image src={icon_2} alt="Decorative graphic" /> Download for Windows</Link></li>
                     </ul>
                     <div className="dm-text mt-15 mb-60 lg-mb-40">Also available for <Link href="/">Android,</Link> and <Link href="/">iOS</Link></div>
                     <div className="fs-24 color-dark "><span className="fw-500 text-decoration-underline">Trusted by 27,000+</span> customers around the world</div>
                  </div>
               </div>
            </div>
         </div>

         <div className="border-bottom border-2 border-white pt-40 lg-pt-20 pb-65 lg-pb-40">
            <div className="container lg">
               <div className="row justify-content-between">
                  {hero_data.map((item) => (
                     <div key={item.id} className="col-lg-4 col-md-6">
                        <div className="card-style-thirteen d-flex w-100 mt-35">
                           <div className="icon d-flex align-items-center justify-content-center border border-2 border-white rounded-circle"><Image src={item.icon} alt="Decorative graphic" /></div>
                           <div className="text">
                              <h6>{item.desc}</h6>
