      ...
      <div className="container">
        ...
        <div className="pr-table-wrapper d-flex flex-wrap">
          ...
          <div className="pr-column">
            ...
            <ul className="feature-list style-none">
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>10 gb Storage</span></li>
              <li><span>200 gb Storage</span></li>
              <li><span>Unlimited Storage</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Virus Protection</span></li>
              <li><span>Online Threat Protection</span></li>
              <li><span>Firewall</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Data Security</span></li>
              <li><span>Onboarding & Support</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Password Manager</span></li>
              <li>1 Device</li>
            </ul>
          </div>
          <div className="pr-column popular">
            <div className="pr-header text-center">
              ...
              <div><span className="fw-500 text-white">Save ~20%</span> when billed yearly</div>
              <Link href="#" className="btn-nineteen w-100 mt-50 lg-mt-30">Add To Cart</Link>
            </div>
            <ul className="feature-list style-none">
              <li><span>10 gb Storage</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>200 gb Storage</span></li>
              <li><span>Unlimited Storage</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Virus Protection</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Online Threat Protection</span></li>
              <li><span>Firewall</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Data Security</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Onboarding & Support</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Password Manager</span></li>
              <li>3 Device</li>
            </ul>
          </div>
          <div className="pr-column">
            <div className="pr-header text-center">
              ...
              <div><span className="fw-500 text-white">Save ~30%</span> when billed yearly</div>
              <Link href="#" className="btn-nineteen w-100 mt-50 lg-mt-30">Add To Cart</Link>
            </div>
            <ul className="feature-list style-none">
              <li><span>10 gb Storage</span></li>
              <li><span>200 gb Storage</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Unlimited Storage</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Virus Protection</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Online Threat Protection</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Firewall</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Data Security</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Onboarding & Support</span></li>
              <li><Image src={icon_1} alt="Decorative graphic" className="icon" /> <span>Password Manager</span></li>
              <li>5 Device</li>
