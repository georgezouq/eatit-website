               ...
               {feature_data.map((item) => (
                  <div key={item.id} className="col-lg-4">
                     <div className="card-style-fifteen text-center mt-25">
                        <div className="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><Image src={item.icon} alt="Decorative graphic" /></div>
                        <h6>{item.title}</h6>
