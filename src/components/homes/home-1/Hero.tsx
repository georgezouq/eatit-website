         ...
         <div className="container position-relative">
            <div className="row">
               <div className="col-lg-7 col-md-7">
                  <p className="fs-24 fw-500 text-white mb-10 wow fadeInUp">Apply Now!</p>
                  <h1 className="hero-heading wow fadeInUp">Global Transfers <span className="d-inline-block position-relative">Quick <Image src={hero_shape1} alt="Decorative graphic" className="d-inline-block" /></span>Savings</h1>
                  <div className="row">
                     <div className="col-xxl-8 col-lg-10">
                        <p className="fs-24 pt-25 pb-30 lg-pb-20 xs-pb-10 wow fadeInUp" data-wow-delay="0.1s">Piku delivered blazing performance, fast striking word solution</p>
                     </div>
                  </div>
                  ...
                  <p className="fs-22 pt-100 md-pt-50 md-pb-20"><span className="fw-500 text-white text-decoration-underline">Join 27,000+</span> companies who’ve reached </p>
               </div>
            </div>
         </div>
            ...
            <div className="container">
               <Swiper {...setting} modules={[Autoplay]} className="partner-logo-one">
                  {logo_data.map((logo, i) => (
                     <SwiperSlide key={i} className="item"><Image src={logo} alt="Decorative graphic" className="m-auto" /></SwiperSlide>
                  ))}
               </Swiper>
            </div>
         </div>
         <Image src={bottom_img} alt="Decorative graphic" className="shapes illustration" />
      </div>
   )
}
