            ...
            <div className="row">
               <div className="col-xxl-7 col-lg-6 order-lg-last">
                  ...
                  <div className="title-one">
								<h2 className="color-dark">Smart Card for business growth</h2>
							</div>
							<p className="fs-28 color-dark fw-500 mt-40 md-mt-20">Piku offers virtual debit cards, FDIC-insured USD accounts through City Savings.</p>
                        ...
                        <div className="row">
                           <div className="col-7">
                              <div className="counter-block-one mt-20">
                                 ...
                                 <span className="fs-22 color-dark">Coverage</span>
                              </div>
                           </div>
                           <div className="col-5">
                              <div className="counter-block-one mt-20">
                                 <div className="main-count fw-500 color-dark"><span className="counter"><Count number={9.1} /></span>M</div>
                                 <span className="fs-22 color-dark">Low interest rate</span>
                              </div>
                           </div>
                        </div>
                     </div>
                     <Link href="/" className="btn-two style-two xl">Order Your Card Now!</Link>
                  </div>
               </div>
               <div className="col-xxl-5 col-lg-6 col-md-7 m-auto text-end order-lg-first">
                  <div className="img-holder z-1 d-inline-block position-relative">
                     <Image src={block_featur1} alt="Decorative graphic" />
                     <Image src={block_featur2} alt="Decorative graphic" className="card_01" />
                     <Image src={block_featur3} alt="Decorative graphic" className="card_02" />
                     <Image src={block_featur4} alt="Decorative graphic" className="shapes shape_01" />
                  </div>
               </div>
            </div>
         </div>
