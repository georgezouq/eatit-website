            ...
            <div className="row align-items-center">
               <div className="col-lg-6">
                  <div className="title-one mb-30 mt-50">
                     <h2 className="color-dark">Globally  Send Money <span className="d-inline-block position-relative">with <Image src={shape_1} alt="Decorative graphic" className="d-inline-block" /></span> <br /> Low Fees</h2>
                  </div>
               ...
               <div className="col-lg-6 col-md-8 m-auto text-end">
                  <div className="img-holder-one position-relative d-inline-block z-1 md-mt-40">
                     <Image src={img_1} alt="Decorative graphic" />
                     <Image src={shape_2} alt="Decorative graphic" className="shapes shape_01" />
                  </div>
               </div>
            </div>
            ...
            <div className="row align-items-center mt-100 md-mt-30">
               <div className="col-lg-6 order-lg-last">
                  <div className="ps-xl-5">
                     <div className="title-one mb-30 mt-50">
                        <h2 className="color-dark">Withdraw money from <span className="d-inline-block position-relative">an ATM <Image src={shape_1} alt="Decorative graphic" className="d-inline-block" /></span></h2>
                     </div>
               ...
               <div className="col-lg-6 col-md-8 m-auto order-lg-first">
                  <div className="img-holder-two position-relative d-inline-block z-1 md-mt-20">
                     <Image src={img_2} alt="Decorative graphic" />
                     <Image src={shape_3} alt="Decorative graphic" className="shapes shape_01" />
                  </div>
               </div>
            </div>
         </div>
