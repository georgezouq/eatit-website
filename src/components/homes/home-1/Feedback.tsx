...
const testi_data: DataType[] = [
   {
      id: 1,
      img: testi_img1,
      title: (<><span className="fw-500 text-white fs-20">Rashed kabir,</span> Lead Designser, Monday</>),
   ...
   },
   {
      id: 2,
      img: testi_img2,
      title: (<><span className="fw-500 text-white fs-20">Jon Cooper, </span> Art Director, Slack</>),
         ...
         <Swiper {...setting} className="feedback-slider-one">
            {testi_data.map((item) => (
               <SwiperSlide key={item.id} className="item">
                  <div className="feedback-block-one bg-one border-30">
                     <div className="d-flex align-items-center justify-content-between">
                        <Image src={item.img} alt="Decorative graphic" />
                        <div className="icon rounded-circle d-flex align-items-center justify-content-center"><Image src={icon} alt="Decorative graphic" /></div>
                     </div>
