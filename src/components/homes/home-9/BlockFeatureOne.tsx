...
const feature_data: DataType[] = [
   {
      ...
      price: (<>Start from <span className="fw-500 text-white">$2.99/mo</span></>),
   },
   {
      id: 2,
      icon: icon_2,
      ...
      <div className="block-feature-twentyFour pb-80 lg-pb-40">
         <div className="container lg">
               ...
               {feature_data.map((item) => (
                  <div key={item.id} className="col-lg-4">
                     <div className="card-style-eleven">
                        <Image src={item.icon} alt="Decorative graphic" />
                        <h4>{item.title}</h4>
                        <p className="m0">{item.price}</p>
                        <div className="d-flex justify-content-end">
                           <Link href="/" className="stretched-link"><Image src={btn_icon} alt="Decorative graphic" /></Link>
                        </div>
                     </div>
                  </div>
               ))}
            ...
            <div className="d-flex justify-content-center justify-content-md-between flex-wrap logos">
               <div><Image src={brand_1} alt="Decorative graphic" /></div>
               <div><Image src={brand_2} alt="Decorative graphic" /></div>
               <div><Image src={brand_3} alt="Decorative graphic" /></div>
               <div><Image src={brand_4} alt="Decorative graphic" /></div>
               <div><Image src={brand_5} alt="Decorative graphic" /></div>
            </div>
         </div>
      </div>
   )
