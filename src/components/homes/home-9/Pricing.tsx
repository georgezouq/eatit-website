      ...
      price_details: [
         {
            ...
            re_price: (<>Reguler price <del className="fw-500 text-white">$13.99</del></>),
         ...
         },
         {
            ...
            re_price: (<>Reguler price <del className="fw-500 text-white">$29.99</del></>),
         ...
         <div className="container lg">
            <div className="row">
               <div className="col-xl-4 col-lg-6 m-auto m-xl-0 text-center text-xl-start">
                  ...
                  <div className="fs-20 fw-500 text-white mt-55 lg-mt-40 mb-15">Billing Cycle</div>
