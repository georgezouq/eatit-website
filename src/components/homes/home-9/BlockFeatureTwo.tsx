            ...
            <div className="row gx-xxl-5">
               <div className="col-lg-4 d-flex">
                  <div className="block-one d-flex flex-column justify-content-center w-100 mt-50 lg-mt-30">
                     <div>
                        <Image src={icon_1} alt="Decorative graphic" />
               ...
               <div className="col-lg-8 d-flex">
                  <div className="block-two w-100 mt-50 lg-mt-30">
                     ...
                     <Image src={thumb_1} alt="Decorative graphic" />
                  </div>
               </div>
               <div className="col-lg-8 d-flex">
                  <div className="block-three w-100 mt-50 lg-mt-30">
                     <div className="row">
                        <div className="col-md-8 ms-auto text-end">
                           <div className="icon d-flex align-items-center justify-content-center rounded-circle"><Image src={icon_2} alt="Decorative graphic" /></div>
                           <blockquote>“Efficient, knowledgeable, & smooth experience. Highly recommended”</blockquote>
                           <div className="name color-dark fs-20"><span className="fw-500">Musa Jamy.</span> CEO babun</div>
                        </div>
                     </div>
                     <Image src={avatar} alt="Decorative graphic" className="shapes shape_01" />
                     <Image src={shape} alt="Decorative graphic" className="shapes shape_02" />
               ...
               <div className="col-lg-4 d-flex">
                  <div className="block-four d-flex flex-column justify-content-center w-100 mt-50 lg-mt-30">
                     <div>
                        ...
                        <Image src={icon_3} alt="Decorative graphic" />
                     </div>
                  </div>
               </div>
            </div>
