               ...
               <div className="col-xl-6 col-lg-7">
                  <div className="pe-xxl-5">
                     <div className="title-ten">
                        ...
                        <h2 className="color-dark">Streamlined <span className="position-relative z-1">Solutions <span className="line" style={{ background: "#FF5B00" }}></span></span> Tailored by Piku for You.</h2>
                     </div>
                     ...
                     <Link href="/" className="btn-five border-0 color-two tran3s">Try It Now</Link>
                  </div>
               </div>
            </div>
         </div>
         <Image src={card} alt="Decorative graphic" className="shapes shape_01" />
