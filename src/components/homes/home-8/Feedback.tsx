...
import icon from "@/assets/images/icon/icon_103.svg"
            ...
            <div className="wrapper">
               <div className="row align-items-center">
                  <div className="col-lg-7 order-lg-last">
                     <Image src={icon} alt="Decorative graphic" />
                     <Swiper {...setting} modules={[Pagination]} className="feedback-slider-five">
                        {testi_data.map((item) => (
                           <SwiperSlide key={item.id} className="item">
                              ...
                              <div className="name fs-24 text-white">
                                 <h6>{item.name}</h6>
                  ...
                  <div className="col-lg-5">
                     <Image src={thumb} alt="Decorative graphic" className="m-auto ms-xl-0 md-mt-40" />
                  </div>
               </div>
            </div>
         </div>
