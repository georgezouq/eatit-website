               ...
               <div className="col-lg-6 order-lg-last d-flex flex-column">
                     ...
                     <div className="row gx-0">
                        <div className="col-sm-6">
                           <div className="counter-block text-center border-style">
                              ...
                              <p className="fs-20 text-white">Piku Resolution Rate</p>
                           </div>
                        </div>
                        <div className="col-sm-6">
                           <div className="counter-block text-center">
                              ...
                              <p className="fs-20 text-white">Happy with AI agent</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="feature-block block-two mt-50 lg-mt-30 w-100">
                     <div className="d-flex">
                        <Image src={img_1} alt="Decorative graphic" className="avatar rounded-circle" />
                        <div className="name">
                           <h6>Daniel Hussy,</h6>
                           <span className="f-20 text-white">CEO & Founder, Piku</span>
                        </div>
                     </div>
                     ...
                     <ul className="style-none d-flex flex-wrap justify-content-between">
                        <li><span><Image src={img_2} alt="Decorative graphic" /></span></li>
                        <li><span><Image src={img_3} alt="Decorative graphic" /></span></li>
                        <li><span><Image src={img_4} alt="Decorative graphic" /></span></li>
                        <li><span><Image src={img_5} alt="Decorative graphic" /></span></li>
                        <li><span><Image src={img_6} alt="Decorative graphic" /></span></li>
                     </ul>
                  </div>
               </div>
               <div className="col-lg-6 d-flex">
                  <div className="feature-block block-three w-100 d-flex align-items-end justify-content-center me-xxl-4 md-mt-40">
                     <Image src={card} alt="Decorative graphic" className="screen" />
