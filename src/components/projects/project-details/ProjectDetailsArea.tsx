         ...
         <div className="container">
            <div className="position-relative">
               ...
               <div className="media-lg">
                  <Image src={project_details_thumb1} alt="Mobile app branding concept" className="w-100" />
               </div>
               ...
               <div className="row">
                  <div className="col-md-8">
                     <div className="media-md mb-25"><Image src={project_details_thumb2} alt="App dashboard screen design" className="w-100" /></div>
                  </div>
                  <div className="col-md-4">
                     <div className="media-md mb-25"><Image src={project_details_thumb3} alt="Finance app interface mockup" className="w-100" /></div>
                     <div className="media-md mb-25"><Image src={project_details_thumb4} alt="Brand guideline layout" className="w-100" /></div>
                  </div>
               </div>
               <h3>Summery</h3>
               <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullaum laboris nisi</p>
